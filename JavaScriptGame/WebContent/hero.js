Player3 = new Player2(150, 50, 40, 50, "./Images/background/galactus3.jpg");
...
/*****PLAYER****/
/**************/
function Player2(x, y, width, height, image)
{
    this.x = x;
    this.y = y;
    this.width = width;
...
Player.prototype.update = function() {
  ...
  if(this.y > InfiniteRunner.height || this.x + this.width < 0){
    ...
    InfiniteRunner.scoreColor = '#94ff00';
...
Platform.prototype.draw = function() {
  InfiniteRunner.fillStyle = this.color;
  InfiniteRunner.fillRect(this.x, this.y, this.width, this.height, this.image);
};
...
InfiniteRunner.setup = function () {
  ...
  this.player = new Player({x: 150, y: 30, width: 50, height: 50, image: ""});
